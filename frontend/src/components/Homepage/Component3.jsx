...
const Component3 = () => {
  return (
    <div className="relative w-auto h-[300px] md:h-[400px] italic mx-3 sm:mx-5 md:mx-10">
      ...
      />
      <div className="absolute inset-0 bg-heading bg-opacity-40 flex flex-col">
        <h1 className="text-mar text-l md:text-xl m-8 mt-6 sm:mt-12 mb-0 font-playfair">
          Unlock the secrets to living well with Yoga
        </h1>
        <p className="text-mar text-l md:text-xl m-8 mt-2 font-lora">
